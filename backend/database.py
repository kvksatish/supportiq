...
async def init_db():
    ...
    async with AsyncSessionLocal() as session:
        ...
        if not existing_workspace:
            ...
            print(f"✓ Created default workspace (ID={default_workspace.id})")
            if default_agent:
                print(f"✓ Created default Agent (ID={default_agent.id})")
        else:
            ...
            if existing_agent_id:
                print(f"✓ Default workspace already exists (ID={existing_workspace.id})")
                print(f"✓ Default Agent already exists (ID={existing_agent_id})")
                ...
                print(f"✓ Default workspace already exists (ID={existing_workspace.id})")
                print(f"✓ Created Agent for default workspace (ID={default_agent.id})")
            else:
                print(f"✓ Default workspace already exists (ID={existing_workspace.id})")
                print("✓ Agent not auto-created, waiting for admin to create in the dashboard")
