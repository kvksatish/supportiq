"""URL fetch and content extraction service - uses Scrapling microservice"""
...
class URLScraper:
    """URL fetcher - fetches via Scrapling microservice"""
...
def check_content_changed(old_hash: str, new_content: str) -> bool:
    """Check whether content has changed"""
