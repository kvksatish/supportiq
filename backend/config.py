...
class Settings(BaseSettings):
    ...
    redis_cache_ttl: int = 3600  # Cache expiration time (seconds)
    redis_rate_limit_ttl: int = 60  # Rate limit window (seconds)
    ...
    def cors_methods_list(self) -> list[str]:
        """Convert comma-separated HTTP methods to list"""
        methods = [
            method.strip()
