	...
	useTranslation: () => ({
		t: (key: string) => {
			const translations: Record<string, string> = {
				"labels.agentName": "Agent Name",
				"labels.presetPersona": "Preset Persona",
				"labels.aiProvider": "AI Provider",
...
describe("AISettingsForm Playground fields", () => {
	it("does not render the Agent Name field in Playground AI settings", async () => {
		...
		expect(screen.queryByDisplayValue("Website Support")).not.toBeInTheDocument();
	});
